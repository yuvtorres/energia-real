from lee_ree import consulta_ree_hour
from analisis_ree import leeree
from dotenv import load_dotenv
import datetime as dt
import sys
sys.path.insert(1, '../')
from connect_db import client_influx

def main():
    
    diff=dt.timedelta(days=30)
    data_ini=dt.datetime(2019,1,1,0,0)
    ...
    while data_fin>data_ini:
        ...
        print('*** probando a escribir ', data[0]['attributes']['values'])
